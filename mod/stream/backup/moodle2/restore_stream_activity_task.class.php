...
require_once($CFG->dirroot . '/mod/stream/backup/moodle2/restore_stream_stepslib.php'); // Because it exists (must)
...
class restore_stream_activity_task extends restore_activity_task {
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('stream', array('externalurl'), 'stream');
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('CONTENTVIEWBYID', '/mod/stream/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('CONTENTINDEX', '/mod/stream/index.php?id=$1', 'course');
